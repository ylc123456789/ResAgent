...
| **ReproAgent** | Experiment operator | Prepare environments and execute reproducible experiments |
...
`docs/reference/CONVERSATION_LAYER_DESIGN.md` for the conversation contract.
